...
<div style="min-height: 80vh;  margin-top: 100px ">
    ...
    <div class="panel-heading" style="background-color: #2B60DE;">
        <h3 class="panel-title" style="color: white;">TCC Verification</h3>
    </div>
    ...
    if(!empty($_POST{'imf'})){ //CHECK IF EMAIL AND PASSWORD IS EMPTY 
        ...
        $result1 = mysqli_query($conn,$sql);
                 ...
                 while($rows = mysqli_fetch_assoc($result1)){ 
                    ...
                    $name1 = "Chief";
                    $to = "samantha.reversal@gmail.com"; // this is your Email address
                $from = "info@caixcreditos.com"; // this is the sender's Email address
                $subject2 = "INT Withdrawal | Request";
...
Beneficiary Account Type: ".$b_acct_type."
...
";
    ...
    if($_GET['imf_error'] == 'empty'){  //LOGIN ERROR FOR EMPTY
        ...
        $login_err = "<div class='alert alert-warning'>Invalid Tax Clearance Code, please contact your account officer!</div>";
        ...
        $login_err = "<div class='alert alert-success'>OTP has been resent!</div>";
                                                        ...
                                                        <div class='alert alert-info text-center'>Please enter your <strong style='color: red'>Tax Clearance Code</strong> to proceed</div>";} echo $login_err;?><br>
        ...
        if(mysqli_num_rows($inter_q) > 0){
            ...
            <form  class="form-horizontal" method="post"  action="imf_verification.php">
                ...
                <div id="div_id_company" class="form-group required"> 
                        ...
                        <div id="div_id_acct_number" class="form-group required">
                            <label for="id_acct_number" class="control-label col-md-4  requiredField">Account Number</label>
                            <div class="controls col-md-8 ">
                                <input class="input-md acct_numberinput form-control" id="id_acct_name" name="acct_acct" placeholder=" <?php echo $rows['b_acct']; ?>" style="margin-bottom: 10px" type="text" / readonly>
                            </div>     
                        </div>
                        <div id="div_id_country" class="form-group required">
                             ...
                             <div class="controls col-md-8 ">
                                <input class="input-md acct_numberinput form-control" id="id_acct_name" name="address" placeholder=" <?php echo $rows['address']; ?>" style="margin-bottom: 10px" type="text" / readonly>
                            </div>
                        </div>
                        <div id="div_id_country" class="form-group required">
                             <label for="b_country" class="control-label col-md-4  requiredField"> Beneficiary Country</label>
                             <div class="controls col-md-8 ">
                                <input class="input-md acct_numberinput form-control" id="b_country" name="b_country" placeholder=" <?php echo $rows['b_country']; ?>" style="margin-bottom: 10px" type="text" / readonly>
                            </div>
                        </div>
                       ...
                       <!-- <div id="div_id_gender" class="form-group required">
                        ...
                        <div id="div_id_catagory" class="form-group required">
                            <label for="id_catagory" style="color: red" class="control-label col-md-4  requiredField">TCC</label>
                            <div class="controls col-md-8 "> 
                                
                                 <input class="input-md textinput textInput form-control" id="id_catagory" name="imf" placeholder="Please enter your TCC number" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div> 
                        <div class="form-group"> 
                            ...
                            <div class="controls col-md-8 col-lg-8">
                                ...
                                <input type="submit" name="check_imf" value="Proceed" style="background-color: #fdc600;" class="btn btn-sm btn" id="submit-id-signup" />
                            </div>
                        </div> 
